...
const domainMap: Record<Env, Record<string, string>> = {
  local: {
    ...
    crm: "crm.africoders.local",
    tools: "tools.africoders.local",
    health: "health.africoders.local",
    ...
    places: "places.africoders.local",
    maps: "maps.africoders.local",
    blog: "blog.africoders.local",
    community: "community.africoders.local",
    help: "help.africoders.local",
    careers: "careers.africoders.local",
    docs: "docs.africoders.local",
    drive: "drive.africoders.local",
  },
  production: {
    ...
    crm: "crm.africoders.com",
    tools: "tools.africoders.com",
    health: "health.africoders.com",
    ...
    places: "places.africoders.com",
    maps: "maps.africoders.com",
    blog: "blog.africoders.com",
    community: "community.africoders.com",
    help: "help.africoders.com",
    careers: "careers.africoders.com",
    docs: "docs.africoders.com",
    drive: "drive.africoders.com",
  },
};
...
function detectEnv(): Env {
  ...
  if (typeof process !== "undefined" && process.env?.NEXT_PUBLIC_ENV) {
    return process.env.NEXT_PUBLIC_ENV.trim() === "production" ? "production" : "local";
  }
...
export function getBroadcastTargets(): string[] {
  return [
    "africoders", "console", "academy", "jobs", "crm",
    "tools", "health", "promptgist", "spaces", "portal",
    "blog", "community", "help", "careers", "docs", "drive",
  ].map((key) => getUrl(key));
}
