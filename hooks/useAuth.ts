...
function setLoggedInFlag(): void {
  if (typeof document !== "undefined") {
    ...
    document.cookie = "africoders_logged_in=1; path=/; domain=.africoders.com; max-age=2592000; SameSite=Lax; Secure";
  }
}

function clearLoggedInFlag(): void {
  if (typeof document !== "undefined") {
    document.cookie = "africoders_logged_in=; path=/; domain=.africoders.com; max-age=0; SameSite=Lax; Secure";
  }
}
