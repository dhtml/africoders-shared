...
function buildFooterLinks() {
  return {
    Platform: [
      { label: "Home",     href: getUrl("africoders") },
      { label: "Docs",     href: getUrl("docs") },
      { label: "Blog",     href: getUrl("blog") },
      { label: "Pricing",  href: getUrl("tools", "/pricing") },
      { label: "Status",   href: getUrl("portal", "/status") },
    ],
    Products: [
      { label: "Academy",  href: getUrl("academy") },
      { label: "Tools",    href: getUrl("tools") },
      { label: "Health",   href: getUrl("health") },
      { label: "Prompts",  href: getUrl("promptgist") },
      { label: "Spaces",   href: getUrl("spaces") },
    ],
    Developers: [
      { label: "API Market",     href: getUrl("portal") },
      { label: "Maps & Places",  href: getUrl("places") },
      { label: "Community",      href: getUrl("community") },
      { label: "API Docs",       href: getUrl("portal", "/docs") },
      { label: "Open Source",    href: "https://github.com/africoders-ng" },
    ],
    Company: [
      { label: "About",   href: getUrl("help", "/about") },
      { label: "Careers",  href: getUrl("careers") },
      { label: "Privacy",  href: getUrl("help", "/privacy") },
      { label: "Cookies",  href: getUrl("help", "/cookies") },
      { label: "Terms",    href: getUrl("help", "/terms") },
    ],
  };
}
...
const socialLinks = [
  ...
  { label: "GitHub", href: "https://github.com/africoders-ng", icon: <Github className="h-4 w-4" /> },
...
export function Footer() {
  ...
  const homeUrl = getUrl("africoders");
  return (
      ...
      <div className="mx-auto px-3 lg:px-4" style={{ maxWidth: "1400px" }}>
        ...
        <div className="pt-14 pb-6">
          ...
          <div className="hidden lg:grid mb-6" style={{ gridTemplateColumns: "3fr 2fr 2fr 2fr 2fr", gap: "1.5rem" }}>
            {/* Brand */}
            <div>
              <a href={homeUrl} className="inline-flex items-center gap-2 mb-3">
